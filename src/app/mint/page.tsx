...
export default function MintPage() {
  ...
  const handleDeposit = async () => {
    ...
    console.log('Depositing', collateralAmount, selectedToken)
  }

  const handleMint = async () => {
    // Implementation will be added later
    console.log('Minting', dscAmount, 'DSC')
  }

  const handleCombined = async () => {
    // Implementation will be added later
    console.log('Depositing and minting', collateralAmount, selectedToken, dscAmount, 'DSC')
  }
